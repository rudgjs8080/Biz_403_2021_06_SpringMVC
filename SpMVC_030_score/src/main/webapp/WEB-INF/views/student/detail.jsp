...
<table class="student_detail">
	<tr>
		<th>학번</th><td>${STU.st_num}</td>
		<th>이름</th><td>${STU.st_name}</td>
	</tr>
	<tr>
		<th>학과</th><td>${STU.st_dept}</td>
		<th>학년</th><td>${STU.st_grade}</td>
	</tr>
	<tr>
		<th>전화번호</th><td>${STU.st_tel}</td>
		<th>주소</th><td>${STU.st_addr}</td>
	</tr>
</table>
<div class="btn_box">
